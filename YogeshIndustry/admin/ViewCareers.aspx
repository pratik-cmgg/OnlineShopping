<%@ Page Title="" Language="C#" MasterPageFile="~/admin/AdminMaster.Master" AutoEventWireup="true" CodeBehind="ViewCareers.aspx.cs" Inherits="YogeshIndustry.admin.ViewCareers" %>
     ...
     <form id="form1" runat="server">
        ...
        <div class="container" style="border:double;height:700px;width:1100px;margin-left:100px;margin-top:50px">
            ...
            <div class="col-lg-6"  style="float:left;height:500px">
                <asp:GridView ID="GridView1" runat="server" Font-Bold="false" BackColor="White" BorderColor="#3366CC" BorderWidth="1px" CellPadding="4" BorderStyle="None" DataKeyNames="CId" CellSpacing="2" Width="298px" AllowCustomPaging="True" OnSelectedIndexChanged="GridView1_SelectedIndexChanged">
            ...
            <div class="col-lg-6" style="float:right;height:600px">
                <div style="position: absolute; width: 400px; height:500px;margin-left:30px;margin-top:50px;border:ridge">
                    <asp:Label ID="lblcar" runat="server" Text="Careers"  Enabled="False" Font-Bold="True" Font-Names="Georgia" Font-Size="Medium"></asp:Label>
                </div>
            </div>
            <!-- display data -->
