...
{
    public partial class ViewOrderedProduct : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            string squery = "select O_Id from OrderedProd";
        ...
        protected void GridView1_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            string squery = "select * from OrderedProd where O_Id = @O_Id";
            SqlCommand com = new SqlCommand(squery, con);
            ...
            details += "Product id   - " + reads[1] + "<br><br>";
            details += "Product name   - " + reads[2] + "<br><br>";
            details += "Order Quantity   - " + reads[3] + "<br><br>";
            details += "Order Total  - " + reads[4] + "<br><br>";
            lblenq.Text = details;
            con.Close();
        }
        ...
        protected void btndel_Click(object sender, EventArgs e)
        {
            SqlConnection con = new SqlConnection(cs);
            int O_Id = Convert.ToInt32(GridView1.SelectedValue);
            string dquery = "delete from OrderedProd where O_Id =" + O_Id;
